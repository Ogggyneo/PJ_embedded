    ...
    <div class="container">
        ...
        <form action="/connect" method="post">
            ...
            <input 
                ...
                id="password" 
                name="password" 
                placeholder="Nếu WiFi không có mật khẩu thì không cần điền">
...
<body>
    ...
    <div class="container">
        ...
        <p>ESP32 đang kết nối vào mạng WiFi của bạn.</p>
        <p class="note">Vui lòng kiểm tra Serial Monitor để xem trạng thái kết nối.</p>
    </div>
